          ...
          <form [formGroup]="contactForm" (ngSubmit)="onSubmit()" novalidate>
            <div class="space-y-6">
              ...
              <div class="text-center">
                <button
                  type="submit"
                  [disabled]="contactForm.invalid && attemptedSubmit()"
                  ...
                  [class.hover:bg-cta-primary-hover]="!(contactForm.invalid && attemptedSubmit())"
                  [class.hover:scale-105]="!(contactForm.invalid && attemptedSubmit())"
                >
                  Envoyer ma demande
                </button>
              </div>
